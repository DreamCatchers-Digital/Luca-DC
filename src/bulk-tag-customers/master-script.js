...
async function downloadAndProcessResults(url) {
  const outputPath = path.join(__dirname, 'bulk_results_50k.jsonl');
  ...
  console.log('✅ All VIP customers processed.');
}
